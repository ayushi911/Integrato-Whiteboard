/*Exception handelling for the modules*/
(function(f) {
...
/*The DOM is the way Javascript sees its containing page data*/
...
/*Get the co ordinates for drawing*/
...
/*Draw according to clients cordinates*/
...
/*Set colour*/
			...
			action.undo();
			this.newStack.push(action);
			
			}
		    this.redoStack.push(this.newStack);
		    if (this.pageStack.length){
		    var topop;
		    topop = this.pageStack.pop();
		...
		LiterallyCanvas.prototype.oldPage = function() {
                    var action;
                    if (!this.undoStack.length) {
                        return;
                    }
		    ...
		    this.pageStack.push(this.newStack);
                    /*action = this.undoStack.pop();
                    action.undo();
                    this.redoStack.push(action);*/
                    this.trigger('undo', {
